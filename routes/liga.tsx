...
export const handler: Handlers<Data, State> = {
  async GET(_req, ctx) {
    ...
    // empatar, a ordem segue alphabetic stable. Delta projetado fica
    // SÓ na /ao-vivo (essa é a página de "tempo real"); /liga mostra
    // standings confirmados, sem ruído.
    times.sort((a, b) => {
  ...
  return (
    <>
      <Head>
        ...
        <link rel="stylesheet" href="/bf-styles.css?v=188" />
      </Head>
      <DesktopSidebar
        active="liga"
